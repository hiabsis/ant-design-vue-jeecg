        ...
        <a-row>
          ...
          <a-col :span="24">
            <a-form-item label="库位" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <a-input v-decorator="['bin']" placeholder="请输入库位"  ></a-input>
            </a-form-item>
          </a-col>
          <a-col :span="24">
            <a-form-item label="备注" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <a-input v-decorator="['ramark']" placeholder="请输入备注"  ></a-input>
            </a-form-item>
          </a-col>
          <a-col :span="24">
            <a-form-item label="纸厂简称	" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <a-input v-decorator="['selller']" placeholder="请输入纸厂简称	"  ></a-input>
            </a-form-item>
          </a-col>
          <a-col :span="24">
          ...
          <a-col :span="24">
            <a-form-item label="货主简称" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <a-input v-decorator="['buyer']" placeholder="请输入货主简称"  ></a-input>
            </a-form-item>
          </a-col>
          <a-col :span="24">
            <a-form-item label="到货车号" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <a-input v-decorator="['carId']" placeholder="请输入到货车号"  ></a-input>
            </a-form-item>
          </a-col>
          <a-col :span="24">
          ...
          <a-col :span="24">
            <a-form-item label="进仓日期" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <j-date placeholder="请选择进仓日期" v-decorator="['buyDate']" :trigger-change="true" style="width: 100%" />
            </a-form-item>
          </a-col>
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/enter/warehouseReceipt/add",
          edit: "/enter/warehouseReceipt/edit",
          queryById: "/enter/warehouseReceipt/queryById"
        }
      }
    },
    computed: {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'brand','kind','level','weight','grand','unit','amount','number','bin','ramark','selller','enterId','buyer','carId','oderId','buyDate'))
        })
      },
      //渲染流程表单数据
      showFlowData(){
      ...
      popupCallback(row){
        this.form.setFieldsValue(pick(row,'brand','kind','level','weight','grand','unit','amount','number','bin','ramark','selller','enterId','buyer','carId','oderId','buyDate'))
      },
    }
  }
</script>