...
<script>
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          ...
          deleteBatch: "/area/area/deleteBatch",
          exportXlsUrl: "/area/area/exportXls",
          importExcelUrl: "area/area/importExcel",
    ...
    methods: {
      ...
      getSuperFieldList(){
        let fieldList=[];
        fieldList.push({type:'string',value:'name',text:'小区名',dictCode:''})
