  ...
  export default {
    ...
    methods: {
      ...
      getSuperFieldList(){
        ...
        fieldList.push({type:'int',value:'departmentid',text:'所属部门',dictCode:''})
        fieldList.push({type:'int',value:'joblevelid',text:'职称',dictCode:''})
        fieldList.push({type:'int',value:'posid',text:'职位',dictCode:''})
